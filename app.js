...
if (limitedSessions.length > 0) {
    const nextSession = limitedSessions[0].sessionType;
    nextSessionElement.textContent = `The next session is ${nextSession}`;

    
    if (nextSession === "OPL" || nextSession === "DSL") {
        nextSessionElement.classList.add("green-glow");
        nextSessionElement.classList.remove("red-glow"); 
    } else if (nextSession === "PPL") {
        nextSessionElement.classList.add("red-glow");
        nextSessionElement.classList.remove("green-glow"); 
    } else {
        nextSessionElement.classList.remove("green-glow", "red-glow"); 
    }
} else {
